...
Cmn.Video = {
    ...
    GetVideoFlashPlayer: function (videoUrl, width, height,classAttr,isAutoPlay) {
        ...
        var _pcVideoHtml = '<object id="vcastr3" class="'+classAttr+'" data="' + _curFileInDir + '/CmnControlRes/player_vcastr/player_vcastr.swf" width="' + width + '" height="' + height + '" type="application/x-shockwave-flash">' +
