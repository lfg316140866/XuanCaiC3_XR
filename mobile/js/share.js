//2015.1.15
//-------------------------------------------------------定义当前站点URL，分享功能会调用到
var siteUrl='http://xuancaic3xr.dongfeng-citroen.com.cn/';
//siteUrl = 'http://xuancaic3xr.nn.cagoe.com/'

//-------------------------------------------------------微信公众号授权
var wxContent={
    timeLink:siteUrl + 'mobile',
    friendLink:siteUrl + 'mobile',
    image:siteUrl + "mobile/images/share.jpg",
    title:'C3-XR自由炫彩',   //发送朋友标题
    friend:'自由色彩，因你精彩',  //发送朋友描述
    timeline:'自由色彩，因你精彩'  //发送朋友圈描述
};
...
function weixin_sign(){
    ...
    $.ajax({
        type:"post",
        url:siteUrl+"/JsApiWXConfig.php?r=" + Math.random(),
        dataType:"text",
		async: false,
    	cache: false,
		data: {
