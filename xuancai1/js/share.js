...
//-------------------------------------------------------微信公众号授权
var wxContent={
    timeLink:siteUrl+'xuancai1/',
    friendLink:siteUrl+'xuancai1/',
    image:siteUrl + "xuancai1/images/share.jpg",
    title:'C3-XR自由炫彩',   //发送朋友标题
    friend:'夏日周末，何不抛开所有烦恼，让色彩陪你自由放纵',  //发送朋友描述
    timeline:'夏日周末，何不抛开所有烦恼，让色彩陪你自由放纵'  //发送朋友圈描述
};
...
function weixin_sign(){
    ...
    $.ajax({
        url:"http://wechat.cagoe.com/JsApiWXConfig.aspx?r=" + Math.random(),
        dataType:"jsonp",
		data: {
